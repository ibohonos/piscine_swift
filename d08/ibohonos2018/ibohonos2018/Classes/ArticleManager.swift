...
//  ibohonos2018
//
//  Created by Ivan BOHONOSIUK on 10/11/18.
//
...
public class ArticleManager: NSObject {
    ...
    public override init() {
        let myBundle = Bundle(identifier: "org.cocoapods.ibohonos2018")
        ...
        let storeURL = docURL?.appendingPathComponent("ibohonos2018.sqlite")
        do {
